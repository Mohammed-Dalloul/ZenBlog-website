...
@section('content')
    <!-- Breadcrumb -->
    <ol class="breadcrumb" style="margin-top: 100px; width: 82%;!important; direction: rtl;!important;">
    ...
    <div class="container-fluid">
        ...
        <div class="animated fadeIn">
            <form action="{{route('settings.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row" style="width: 85%;!important;">
                    @if ($errors->any())
                    ...
                    @endif
                    <div class="card" style="direction: rtl;!important;">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img src="{{asset($setting->logo)}}" alt="not found" style="height: 50px">
                            </div>
                            <div class="form-group col-md-6">
                                <label>{{ __('words.favicon') }}</label>
                                <img src="{{asset($setting->favicon)}}" alt="not found" style="height: 50px">
                            </div>
                            <div class="form-group col-md-6">
                                <label>{{ __('words.logo') }}</label>
