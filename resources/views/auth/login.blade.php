...
<head><base href="../../../../">
    ...
    <link href="assets/plugins/custom/prismjs.bundle.css?v=7.0.4" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="login-aside d-flex flex-column flex-row-auto">
            <!--begin::Aside Top-->
            <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15" style="margin-top: -150px;!important;">
                <!--begin::Aside header-->
            ...
            <!--end::Aside Top-->
            <!--begin::Aside Bottom-->
            <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100% + 5rem); background-image: url(assets/media/login-visual-5.svg)"></div>
            <!--end::Aside Bottom-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
        <div class="login-content flex-row-fluid d-flex flex-column p-10">
            ...
            <!--end::Top-->
            <!--begin::Wrapper-->
            <div class="d-flex flex-row-fluid flex-center" style="margin-bottom: 100px;!important;">
                <!--begin::Signin-->
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="email" type="email"
                                   class="form-control h-auto py-7 px-6 rounded-lg @error('email') border-0 @enderror" name="email"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="password" type="password"
                                   class="form-control h-auto py-7 px-6 rounded-lg @error('password') border-0 @enderror" name="password"
                                   required>
...
<script src="assets/js/plugins.bundle.js?v=7.0.4"></script>
<script src="assets/js/prismjs.bundle.js?v=7.0.4"></script>
...
{{--                <div class="card-body">--}}
{{--                    <form method="GET" action="{{ route('frontsite.index') }}">--}}
{{--                        @csrf--}}
