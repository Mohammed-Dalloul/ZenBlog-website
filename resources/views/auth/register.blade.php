...
<head><base href="../../../../">
    ...
    <link href="assets/css/pages/login/login-3.css?v=7.0.4" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid wizard" id="kt_login">
        ...
        <div class="login-aside d-flex flex-column flex-row-auto">
            ...
            <!--end::Aside Top-->
            <!--begin::Aside Bottom-->
            <div class="aside-img-wizard d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center pt-2 pt-lg-5" style="background-position-y: calc(100% + 3rem); background-image: url(assets/media/features.svg); margin-bottom: 200px; !important;"></div>
            <!--end::Aside Bottom-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
        <div class="login-content flex-column-fluid d-flex flex-column p-10">
            ...
            <h1 style="color: rgb(61,61,61); padding: 100px 0px 0px 130px; font-weight: bold">Create Account</h1>

            <!--end::Top-->
            <!--begin::Wrapper-->
            <div class="d-flex flex-row-fluid flex-center" style="margin-top: 60px; !important;">
                <!--begin::Signin-->
                <div class="login-form login-form-signup">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                        ...
                        <div class="flex flex-wrap">
                            <label for="name" class="font-size-h6 font-weight-bolder text-dark"> {{--class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4"--}}
                                {{ __('Name') }}:
                            </label>

                            <input id="name" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg @error('name') font-size-h6 @enderror" {{-- class="form-input w-full @error('name')  border-red-500 @enderror" --}}
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="email" type="email"
                                   class="form-control h-auto py-7 px-6 border-0 rounded-lg @error('email') font-size-h6 @enderror" name="email"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="password" type="password"
                                   class="form-control h-auto py-7 px-6 border-0 rounded-lg @error('password') font-size-h6 @enderror" name="password"
                        ...
                        <div class="flex flex-wrap">
                            <label for="password-confirm" class="font-size-h6 font-weight-bolder text-dark">
                                {{ __('Confirm Password') }}:
                            </label>

                            <input id="password-confirm" type="password" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6"
...
{{--                                        <!--end::Svg Icon-->--}}
{{--										</span></button>--}}
{{--                                <button type="button" href="frontsite/index" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" data-wizard-type="action-next">Next Step--}}
...
<script src="assets/plugins/custom/prismjs.bundle.js?v=7.0.4"></script>
<script src="assets/js/scripts.bundle.js?v=7.0.4"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Scripts(used by this page)-->
<script src="assets/js/login-3.js?v=7.0.4"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>
