...
class PostsController extends Controller
{
    ...
    use ImageTrait; use UploadImage;
    protected $postmodel;
    ...
    {
        return view('frontsite.posts.index');
    }
    ...
    public function create()
    {
        ...
        if (count($categories)>0) {
            return view('frontsite.posts.add' , compact('categories'));
        }
        abort(404);
    ...
    public function edit(Post $post)
    {
        ...
        $categories = Category::all();
        return view('frontsite.posts.edit' , compact('post','categories'));
    }
