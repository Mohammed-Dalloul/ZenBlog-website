...
class CategoryController extends Controller
{
    ...
    {
        return view('frontsite.categories.index');
    }
        ...
        return  Datatables::of($data)
            ...
            ->addColumn('action', function ($row) {
                ...
                if (auth()->user()->can('viewAny', $this->setting)) {
                    return $btn = '
                        <a href="' . Route('frontsite.category.edit', $row->id) . '"  class="edit btn btn-success btn-sm" ><i class="fa fa-edit"></i></a>
    ...
    public function create()
    {
        ...
        return view('frontsite.categories.add', compact('categories'));
    }
    ...
    public function edit(Category $category)
    {
        $this->authorize('viewAny', $this->setting);
        $categories = Category::whereNull('parent')->orWhere('parent', 0)->get();
        return view('frontsite.categories.edit', compact('category', 'categories'));
    }
